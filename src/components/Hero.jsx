...
const Hero = () => {
  return (
    ...
    lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connection and turning big ideas into interactive digital experiences.</p>

        <div>
          <img src={assets.hero_img} alt='' className='w-full max-w-6xl'/>
          <img src={assets.bgImage1} alt='' className='absolute -top-40 -right-40 sm:top-2 sm:-right-70 -z-1 dark-hidden' />
        </div>
